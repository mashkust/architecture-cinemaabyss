...
| `monolith.image.repository`          | Monolith image repository   | `ghcr.io/mashkust/architecture-cinemaabyss/monolith` |
...
| `proxyService.image.repository`          | Proxy service image repository   | `ghcr.io/mashkust/architecture-cinemaabyss/proxy-service` |
...
| `moviesService.image.repository`          | Movies service image repository   | `ghcr.io/mashkust/architecture-cinemaabyss/movies-service` |
...
| `eventsService.image.repository`          | Events service image repository   | `ghcr.io/mashkust/architecture-cinemaabyss/events-service` |
